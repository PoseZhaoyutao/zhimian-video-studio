...
description: Use when producing or reviewing 智面引擎 daily/on-demand vertical videos about AI, algorithm interviews, backend interviews, AI usage tips, VoxCPM2 narration, Remotion animation, platform copy, dated output packages, or prompts like “生成今天的视频”, “调用AI科普视频Skill”, and “重做今天的视频”.
---
...
- Use `references/content-calendar.md` to select the 30-day topic.
...
2. Pick the topic from the calendar unless the user provides a specific topic.
3. Research with primary sources. Prefer official docs, papers, or authoritative source code. 不得伪造来源.
4. Write `script/narration.md` and `script/timeline.json` with one scene per concept.
